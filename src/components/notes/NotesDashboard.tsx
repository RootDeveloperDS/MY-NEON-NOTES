...
export function NotesDashboard() {
  ...
  const [isDeletingViewer, setIsDeletingViewer] = useState(false);
    ...
    <div className="relative flex min-h-screen flex-col p-4 md:p-8 pb-4 md:pb-8">
      ...
      <AlertDialog open={isViewerDeleteDialogOpen} onOpenChange={setIsViewerDeleteDialogOpen}>
        <AlertDialogContent>
          ...
          <AlertDialogFooter>
            <AlertDialogCancel disabled={isDeletingViewer}>Cancel</AlertDialogCancel>
            <AlertDialogAction
