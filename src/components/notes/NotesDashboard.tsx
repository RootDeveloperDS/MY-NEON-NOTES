...
// Bolt Optimization: Extract sidebar note item to a separate memoized component to avoid O(n) rendering recalculations (e.g., formatDistanceToNow) when unrelated state changes.
const SidebarNoteItem = React.memo(({ note, isActive, onClick }: { note: Note, isActive: boolean, onClick: (note: Note) => void }) => {
...
export function NotesDashboard() {
  ...
  // Bolt Optimization: Stable callbacks for memoized NoteViewer
