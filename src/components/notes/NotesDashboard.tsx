...
const SidebarNoteItem = memo(function SidebarNoteItem({ note, isActive, onView }: SidebarNoteItemProps) {
...
export function NotesDashboard() {
  ...
  }, [viewingNote, toast, user?.displayName, user?.email]);
  ...
  const handleOpenDeleteViewer = useCallback(() => {
            ...
            <div className="mt-8">
              ...
              <div className="hidden min-w-0 lg:block">
                <NoteViewer
                  ...
                  onDelete={handleOpenDeleteViewer}
                />
              </div>
            </div>
          )}
