              ...
              <>
                <TabsContent value="signin" className="space-y-3 pt-3">
                  <form onSubmit={form.handleSubmit(v => handleEmailSubmit(v, 'signIn'))}>
                    <AuthFormFields form={form} isSignUp={false} />
                ...
                <TabsContent value="signup" className="space-y-3 pt-3">
                  <form onSubmit={form.handleSubmit(v => handleEmailSubmit(v, 'signUp'))}>
                    <AuthFormFields form={form} isSignUp={true} />
            ...
            <FormField
                ...
                render={({ field }) => (
                    <FormItem className="space-y-1">
                        ...
                        <FormControl>
                            <Input placeholder="user@gmail.com" className="font-auth-input h-9 text-sm" {...field} autoComplete="email" />
                        </FormControl>
            ...
            <FormField
                ...
                render={({ field }) => (
                    <FormItem className="space-y-1">
                        ...
                        <FormControl>
                            <Input type="password" placeholder="P4$sW9rd" className="font-auth-input h-9 text-sm" {...field} autoComplete={isSignUp ? "new-password" : "current-password"} />
                        </FormControl>
                        <FormMessage className="text-[11px]" />
                    </FormItem>
                )}
